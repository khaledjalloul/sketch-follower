...
public:
	MoveitInterface(ros::NodeHandle &n)
	{
		...
		ros::Rate r(20);
		ros::Subscriber sub = n.subscribe<geometry_msgs::Pose2D>("/cursor_position", 10, &MoveitInterface::cursorCb, this);
		ros::Publisher pub = n.advertise<geometry_msgs::Pose2D>("/eef_position", 10);
